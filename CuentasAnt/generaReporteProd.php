        ...
        for ($i=0; $i < $numfilasH; $i++) //historico de la consulta general
            {
                ...
                $pdf->SetWidths(array(20,55,25, 30, 20, 25));
                $pdf->SetFont('Arial','B',10);
                $pdf->SetFillColor(85,107,47);
                $pdf->SetTextColor(255);
                $pdf->Row(array('Núm Fact','Cliente','Fecha_Venta','Presentación','Cantidad','Precio Venta'));
                ...
                $cantT+=$filaG['cantidad'];
                    ...
                    if($i%2 == 1)
                    {
                        ...
                        $pdf->SetTextColor(0);
                        $pdf->Row(array($filaG['id'],$filaG['name'],$filaG['fecha'],$filaG['descripcion'], $filaG['cantidad'],$filaG['price_out']));
                    }
                    else
                    {
